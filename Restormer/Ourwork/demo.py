...
with torch.no_grad():
    for file_ in tqdm(files):
        ...
        if task == 'Gaussian_Gray_Denoising':
            ...
            img = load_img(file_)
            # img = load_img('/Users/shuogudaojin/Course/JHU_601.661_2025Fall/Restormer/demo/restored/Single_Image_Defocus_Deblurring')
        ...
        if task == 'Gaussian_Gray_Denoising':
            ...
            save_gray_img((os.path.join(out_dir, f+'_input.png')), input_)
        else:
            save_img((os.path.join(out_dir, f+'.png')), restored)
            save_img((os.path.join(out_dir, f+'_input.png')), input_)
